...
<body class="p-0">
    ...
    <center>
        ...
        ?>
        <h4>Commissaire : <strong> <?php echo e($comm->email.' | '.$comm->name); ?> </strong></h4>
    </center>
        ...
        <table class="w-100 table" border="all">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center p-2"><?php echo e($eff_total); ?></td>
                    <td class="text-center"><?php echo e($pourcent_total); ?> %</td>
                </tr>
                <tr>
                    <td>Demande non traité</td>
                    <td class="text-center p-2"><?php echo e($eff_nontraite); ?></td>
                    <td class="text-center"><?php echo e($pourcent_nontraite); ?> %</td>
                </tr>
                <tr>
                    <td>Demande Traité</td>
                    <td class="text-center p-2"><?php echo e($eff_traite); ?></td>
                    <td class="text-center"><?php echo e($pourcent_traite); ?> %</td>
                </tr>
                <tr>
                    <td>Demande Traité</td>
                    <td class="text-center p-2"><?php echo e($eff_traite); ?></td>
                ...
                <tr>
                    ...
                    <td class="text-center p-2"><?php echo e($eff_fav); ?></td>
                    <td class="text-center"><?php echo e($pourcent_fav); ?> %</td>
                </tr>
                <tr>
                    <td>Demande Réservé</td>
                    <td class="text-center p-2"><?php echo e($eff_res); ?></td>
                    <td class="text-center"><?php echo e($pourcent_res); ?> %</td>
                </tr>
                <tr>
                    <td>Demande Défavorable</td>
                    <td class="text-center p-2"><?php echo e($eff_def); ?></td>
                    <td class="text-center"><?php echo e($pourcent_def); ?> %</td>
                </tr>
...
<p>
    Imprimé par : <?php echo e(Auth::user()->name); ?>
...
<?php /**PATH /home/ezechiel/AllocationTche/resources/views/upb/pdf_stats_lot.blade.php ENDPATH**/ ?>