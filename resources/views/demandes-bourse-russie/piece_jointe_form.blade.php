...
@if (count(App\Models\PieceJointeRussie::whereNotIn(
        'id',
...
@else
    <a href="/pdf-bourse-russie/{{ $demandesBourseRussie->id }}">
    ...
    @forelse (App\Models\PieceJointeRussie::all() as $pj)
        ...
        <li class="list-group-item">
            @if ($assocPJdemande == null)
                ...
                @else
                    <form method="POST"
                        action="{{ route('demandes-bourse-russie.update', $demandesBourseRussie->id) }}" role="form"
