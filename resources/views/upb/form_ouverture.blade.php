                ...
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <p>Plateforme de demande d'allocation el ligne disponible du
                            <strong>{{ $reg->DateOuverture }}</strong> au <strong>{{ $reg->DateFermeture }}</strong>
                        </p>
                    ...
                    <div class="row">
                        <div class="col-12 my-3">
                            <div class="text-center">
                                ...
                                {{-- <div class="card w-auto shadow py-3 " style="border-radius: 10px; width:auto">
                                    <div class="h2 text-success">Ouverture / Cloture de la Plateforme des Demandes
                                        d'Allocation
                                        Universitaire</div>
                                </div> --}}
                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 text-start my-2">
                                                ...
                                                <input type="date" class="form-control my-1" id="DateOuverture"
                                                    value="{{ old('DateOuverture') ?? $reg->DateOuverture }}"
                                                    name="DateOuverture" required>
                                                {!! $errors->first('DateOuverture', '<div class="invalid-feedback">:message</div>') !!}
                                                {!! $errors->first('DateOuverture', '<div class="text-danger">:message</div>') !!}
                                            ...
                                            <div class="col-12 text-start my-2">
                                                ...
                                                <input type="date" class="form-control my-1" name="DateFermeture"
                                                    value="{{ old('DateFermeture') ?? $reg->DateFermeture }}" required>
                                                {!! $errors->first('DateFermeture', '<div class="invalid-feedback">:message</div>') !!}
                                                {!! $errors->first('DateFermeture', '<div class="text-danger">:message</div>') !!}
                                                <small id="email" class="text-muted ">
                                                    <i class="fa-solid fa-circle-info text-italic me-1 "></i>
