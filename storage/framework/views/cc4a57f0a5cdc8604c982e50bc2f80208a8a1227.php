...
<fieldset>
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-12 my-2">
            ...
            <?php echo e(Form::text('nom', $demandesBourseChinoise->nom, ['class' => 'form-control' . ($errors->has('nom') ? ' is-invalid' : ''), 'placeholder' => 'Nom'])); ?>
        ...
        <div class="col-md-5 col-12 my-2">
            ...
            <?php echo e(Form::text('prenoms', $demandesBourseChinoise->prenoms, ['class' => 'form-control' . ($errors->has('prenoms') ? ' is-invalid' : ''), 'placeholder' => 'Prenoms'])); ?>
        ...
        <div class="col-md-2 col-12 my-2">
            ...
            <div class="col-md-4 col-12 my-2 <?php if($demandesBourseChinoise->diplome_de_base != 'BAC'): ?> <?php else: ?> hide <?php endif; ?>" id="non_bac_fields">
                <strong class="text-dark"> <?php echo e(Form::label('filiere_du_diplome_de_base')); ?> </strong>
                <?php echo e(Form::text('serie_ou_filiere', $demandesBourseChinoise->serie_ou_filiere, ['class' => 'form-control' . ($errors->has('serie_ou_filiere') ? ' is-invalid' : ''), 'placeholder' => 'Serie Ou Filiere'])); ?>

                <?php echo $errors->first('serie_ou_filiere', '<div class="invalid-feedback">:message</div>'); ?>

            </div>
            <div class="col-md-4 col-12 my-2 <?php if($demandesBourseChinoise->diplome_de_base != 'BAC'): ?> hide <?php else: ?> <?php endif; ?>" id="bac_fields">
            ...
            <div class="col-md-4 col-12 my-2">
                ...
                <?php echo e(Form::select('filiere_choisi', $demandesBourseChinoise->listeFiliere(), $demandesBourseChinoise->filiere_choisi, ['class' => 'form-select' . ($errors->has('filiere_choisi') ? ' is-invalid' : ''), 'placeholder' => '-- Sélectionner --'])); ?>
