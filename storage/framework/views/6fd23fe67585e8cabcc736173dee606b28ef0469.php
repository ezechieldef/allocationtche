        ...
        <div class="">
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('demandes-bourse-russie.update', $demandesBourseRussie->id)); ?>"  role="form" enctype="multipart/form-data">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ezechiel/AllocationTche/resources/views/demandes-bourse-russie/edit.blade.php ENDPATH**/ ?>