...
<head>
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="<?php echo e(url('assets/css/material-dashboard.css?v=3.0.4')); ?>" rel="stylesheet" />
    <title>DBAU</title>
</head>
...
<footer style=" bottom:0; width:100%; ">
    ...
    <script src="<?php echo e(url('assets/js/material-dashboard.min.js?v=3.0.4')); ?>"></script>
</body>

</html>
<?php /**PATH /home/ezechiel/AllocationTche/resources/views/auth/template.blade.php ENDPATH**/ ?>