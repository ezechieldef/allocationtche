...
class Parametres
{
    ...
    // 'apiperso' => 'https://beraca-transport.net/envoi_note/c.php?matricule={Matricule}&annee_academique={AnneeAcademique}'
    const UNIVERSITE = [
        'UAC2022' => ['api' => 'https://scolarite.uac.bj:9443/Higher_Education_UAC/api/inscriptions/{Matricule}/{AnneeAcademique}', 'token' => ''],
        'UAC2021' => [ 'api' => 'https://scolarite.uac.bj:9443/Higher_Education_UAC/api/inscriptions/{Matricule}/{AnneeAcademique}', 'token' => ''],
        'UAC2020' => [ 'api' => 'https://scolarite.uac.bj:9443/Higher_Education_UAC/api/inscriptions/{Matricule}/{AnneeAcademique}', 'token' => ''],
