                                ...
                                <tbody>
                                    <?php $__currentLoopData = $prop_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $correspondanceFiliere): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($correspondanceFiliere->nouveau); ?></td>
                                            <td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ezechiel/AllocationTche/resources/views/correspondance-filiere/corresp_temp_sel.blade.php ENDPATH**/ ?>