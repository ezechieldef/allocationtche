            ...
            <fieldset>
                ...
                <div class="row">
                    <div class="col-md-4 col-12 my-2">
                        ...
                        {{-- {{ Form::select('niveau_sollicite', ['LICENCE' => 'LICENCE', 'MASTER' => 'MASTER', 'DOCTORAT' => 'DOCTORAT', 'SPECIALISATION' => 'SPECIALISATION'], $demandesBourseChinoise->filiere_choisi, ['class' => 'form-select' . ($errors->has('niveau_sollicite') ? ' is-invalid' : ''), 'placeholder' => '-- Sélectionner --']) }} --}}
