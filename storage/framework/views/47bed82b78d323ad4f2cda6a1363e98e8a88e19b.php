...
<?php if(count(App\Models\PieceJointeChine::whereNotIn(
        'id',
...
<?php else: ?>
    <a href="/pdf-bourse-chine/<?php echo e($demandesBourseChinoise->id); ?>">
    ...
    <?php $__empty_1 = true; $__currentLoopData = App\Models\PieceJointeChine::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <li class="list-group-item">
            <?php if($assocPJdemande == null): ?>
                ...
                <?php else: ?>
                    <form method="POST"
                        action="<?php echo e(route('demandes-bourse-chinoise.update', $demandesBourseChinoise->id)); ?>" role="form"
...
<?php /**PATH /home/ezechiel/AllocationTche/resources/views/demandes-bourse-chinoise/piece_jointe_form.blade.php ENDPATH**/ ?>